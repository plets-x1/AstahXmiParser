...
namespace Plets.Data.Xmi {
        public static class LoadRunnerImporter {
            ...
            auxTDparameters = auxItemData2[0] + "
                                @ @" + auxItemData2[1] + " |";
